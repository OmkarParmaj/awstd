    ...
    if (designfilePath) {
        ...
        const sql = `
            INSERT INTO beaminward (
                ...
                width, drawinprice, reedprice, note, club, barcodevalue, beamstatus, designfile
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
        ...
        const sql = `
            INSERT INTO beaminward (
                ...
                SizingName, SizingMtr, Count1, Count2, Count3, Count4, Count5, 
                Countwt1, Countwt2, Countwt3, Countwt4, Countwt5, company, party, 
                width, club, barcodevalue, beamstatus, jacquardfile
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
        ...
        const sql = `
            INSERT INTO beaminward (    
                ...
                SizingName, SizingMtr, Count1, Count2, Count3, Count4, Count5, 
                Countwt1, Countwt2, Countwt3, Countwt4, Countwt5, company, party, 
                width, club, barcodevalue, beamstatus
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
...
app.all('/beaminwardedit/:id', upload2.fields([
    ...
    if (designfilePath) {
        sqlput1 = "UPDATE `beaminward` SET `Date` = ?, `UID` = ?, `SetNo` = ?, `DesignNo` = ?, `WarpCount` = ?, `WeftCount` = ?, `Reed` = ?, `Pick` = ?, `SizingName` = ?, `SizingMtr` = ?, `Count1` = ?, `Count2` = ?, `Count3` = ?, `Count4` = ?, `Count5` = ?, `Countwt1` = ?, `Countwt2` = ?, `Countwt3` = ?, `Countwt4` = ?, `Countwt5` = ?, width =?, `club`= ?, `designfile`= ? WHERE `Email` = ? AND `srno` = ?";
        connection.query(sqlput1, values, (err, result) => {
            if (err) return res.json({ message: "Error in the internal server" });
            return res.json({ message: "Added successfully" });
        });
    } else if (jacquardfilePath) {
        sqlput2 = "UPDATE `beaminward` SET `Date` = ?, `UID` = ?, `SetNo` = ?, `DesignNo` = ?, `WarpCount` = ?, `WeftCount` = ?, `Reed` = ?, `Pick` = ?, `SizingName` = ?, `SizingMtr` = ?, `Count1` = ?, `Count2` = ?, `Count3` = ?, `Count4` = ?, `Count5` = ?, `Countwt1` = ?, `Countwt2` = ?, `Countwt3` = ?, `Countwt4` = ?, `Countwt5` = ?, width =?, `club`= ?, `jacquardfile`= ? WHERE `Email` = ? AND `srno` = ?";
        connection.query(sqlput2, values2, (err, result) => {
            if (err) return res.json({ message: "Error in the internal server" });
            return res.json({ message: "Added successfully" });
        });
    } else {
        sqlput = "UPDATE `beaminward` SET `Date` = ?, `UID` = ?, `SetNo` = ?, `DesignNo` = ?, `WarpCount` = ?, `WeftCount` = ?, `Reed` = ?, `Pick` = ?, `SizingName` = ?, `SizingMtr` = ?, `Count1` = ?, `Count2` = ?, `Count3` = ?, `Count4` = ?, `Count5` = ?, `Countwt1` = ?, `Countwt2` = ?, `Countwt3` = ?, `Countwt4` = ?, `Countwt5` = ?, width =?, `club`= ? WHERE `Email` = ? AND `srno` = ?";
...
app.get('/productiondashboard', authenticateJWT, (req, res) => {
    ...
    const sql = `SELECT *,
       ROUND(avrageeff) AS aeff,
       ROUND(totalprice) AS bill
FROM production
...
extracted_data AS (
    ...
    JOIN 
        indices
    ON 
        production.Email = "omkarparmaj1@gmail.com"
    WHERE 
...
WHERE 
    beaminward.Email = "omkarparmaj1@gmail.com" 
    AND loomstatus.email = "omkarparmaj1@gmail.com"
GROUP BY 
    beaminward.DesignNo, 
    loomstatus.designno`;
...
app.put('/loomstatusupdate/:id', authenticateJWT, (req, res) => {
    ...
    const { loom, design, ud } = req.body;
    console.log(loom);
    console.log(design)
    console.log(ud)

    const sql = "UPDATE `loomstatus` SET `loomno`= ?,`designno`= ?,`uid`= ? WHERE `designno` = ? and `email` = ?"

    connection.query(sql, [loom, design, ud, id, loomstatusupdatemail], (err, result) => {
        if (err) return res.json(err);
