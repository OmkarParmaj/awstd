...
const BillPrint = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/billprint/${id}`, { withCredentials: true })
            .then(res => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/companyregister/${id}`, { withCredentials: true })
            .then(res => {
                // console.log(res.data);
                setFirm(res.data[0]);
            })
                ...
                <div className="row mt-3">
                    ...
                    <div className="col">
                        <div className="container-fluid border border-1">
                            ...
                            <div className="row mt-2 scroll me-3 ms-3" style={{marginBottom: "300px"}} >
