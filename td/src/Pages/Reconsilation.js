...
const Reconsilation = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/reconsilecompany/${id}`, {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response1 = await axios.get(`http://localhost:5000/reconsilation/${id}`, { withCredentials: true });
                const response2 = await axios.get(`http://localhost:5000/packslip/${id}/${id1}`, { withCredentials: true });
                const response3 = await axios.get(`http://localhost:5000/yarninward/${id}`, { withCredentials: true });
                const response4 = await axios.get(`http://localhost:5000/billingreport/${id}/${id1}`, { withCredentials: true });
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/reconsilationbeaminward/${id}/${id1}`, { withCredentials: true })
            .then(res => {
                ...
                setUrl(`https://www.textilediwanji.com/scanreco?setno=${setno1}&designno=${designno1}&recoemail=${email1}`);
    ...
    //     const pdfname = "omkarreconsilation"
    //     const mydocument = document.querySelector('#invoice');
    ...
    return (
        <>
                    ...
                    <div className='col-12 col-sm-10 rightone border border-1'>
                        ...
                        <div >
                            <div className="mt-4 mb-4">
                                <div className="card mt-1 mb-1 border border-0 ms-2 me-2">
                                    <div className="card-body">
                                        <div className="row d-flex justify-content-end align-items-center">
                                            <div className="col-3 d-flex justify-content-end">
                                                {/* <button className="btn btn-primary btn-sm" onClick={downloadpdf}>Download pdf</button> */}
                                                <button className="btn btn-success btn-sm ms-2" onClick={handleprint}>Print</button>
                                        ...
                                        <div className="row mt-3 ms-2 me-2" id="invoice">
                                            ...
                                            <div className="container border border-1 mobilecontainer ">
                                                ...
                                                <div className="row">
                                                    <div className="col-4 col-md-2  border-bottom d-flex justify-content-center align-items-center ">
                                                        <img src={`http://localhost:5000/companyimage/${company.filenameas}`} style={{ maxWidth: 250, maxHeight: 90 }} alt={`Image ${company.filenameas}`} />
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    {pack.map((packdata, index) => (
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td>{packdata.totalwt.toFixed(2)}</td>
                                                            ...
                                                            <table className="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    {billingreport.map((o, index) => (
                                                                        <tr key={index}>
                                                                            <td>{o.prefix}{o.billNo}{o.suffix}</td>
            ...
            <div className="container-fluid printreconsilation" style={{visibility: "hidden"}}>
                <div className="row mt-3 ms-2 me-2 " id="invoice">
