...
const Reco = () => {
    ...
    useEffect(() => {
        ...
        var setno = Decrypt(query.get('setno'), secreatekey);
        var designno = Decrypt2(query.get('designno'), secreatekey);
        var recoemail = Decrypt2(query.get('recoemail'), secreatekey);
        // const emailid = query.get('emailid');
        // setSetno(setnumber)
        // setDesignno(designnumber)
        // setRecoemail(reconsilationmail)

        var snumber = query.get('setno');
        var dnumber = query.get('designno');
        var remail = query.get('recoemail');
        ...
        const fetchData = async () => {
            try {
                ...
                const response2 = await axios.get(`https://www.api2.textilediwanji.com/packslip?setno=${setno}&designno=${designno}&recoemail=${recoemail}`, {withCredentials:true});
