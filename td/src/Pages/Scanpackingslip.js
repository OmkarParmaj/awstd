...
const Scanpackingslip = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://www.api2.textilediwanji.com/packingdata?packingslipno=${packingslipno}&uidno=${uidno}&serialno=${serialno}&emailid=${emailid}`)
...
export default Scanpackingslip;
